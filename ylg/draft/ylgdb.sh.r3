...
value[22.103]="fully qualified Pod hostname will be hostname(Defailt nothing)"
tag[22.103]="1"
...
tag[26.101]="1"
spec[26.102]="image:"
value[26.102]="Container image name"
tag[26.102]="1"
spec[26.103]="imagePullPolicy:"
value[26.103]="Image pull policy(Always"
tag[26.103]="Never"
spec[26.104]="command:"
value[26.104]="Entrypoint array. Not executed within a shell. The container image's ENTRYPOINT is used if this is not provided"
tag[26.104]="1"
spec[26.105]="args:"
value[26.105]="Arguments to the entrypoint. The container image's CMD is used if this is not provided"
tag[26.105]="1"
spec[26.106]="workingDir:"
value[26.106]="Container's working directory.(Default-the container runtime's default will be used)"
tag[26.106]="1"
spec[26.107]="env:"
value[26.107]="List of environment variables to set in the container"
tag[26.107]="0"
spec[26.1071]="name:"
value[26.1071]="Name of the environment variable"
tag[26.1071]="1"
spec[26.1072]="value:"
value[26.1072]="are expanded using the previously defined environment variables in the container and any service environment variables"
tag[26.1072]="1"
spec[26.1073]="valueFrom:"
value[26.1073]="Source for the environment variable's value. Cannot be used if value is not empty."
tag[26.1073]="0"
spec[26.10731]="configMapKeyRef:"
value[26.10731]="Selects a key from a ConfigMap"
tag[26.10731]="0"
spec[26.107311]="key:"
value[26.107311]="configMapKeyRef key to select"
tag[26.107311]="1"
spec[26.107312]="name:"
value[26.107312]="configMapKeyRef Name of the referent"
tag[26.107312]="1"
spec[26.107313]="optional:"
value[26.107313]="Specify whether the ConfigMap or its key must be defined(Boolean)"
tag[26.107313]="1"
spec[26.10732]="fieldRef:"
value[26.10732]="Selects a field of the pod(supports metadata.name/metadata.namespace/metadata.labels['<KEY>']/metadata.annotations['<KEY>']/spec.nodeName/spec.serviceAccountName/status.hostIP/status.podIP/status.podIPs)"
tag[26.10732]="1"
spec[26.10733]="resourceFieldRef:"
value[26.10733]="Selects a resource of the container(linits Request are supported)"
tag[26.10733]="1"
spec[26.10734]="secretKeyRef:"
value[26.10734]="Selects a key of a secret in the pod's namespace"
tag[26.10734]="0"
spec[26.107341]="key:"
value[26.107341]="key of the secret to select from"
tag[26.107341]="1"
spec[26.107342]="name:"
value[26.107342]="Name of the referent of secretKeyRef"
tag[26.107342]="1"
spec[26.107343]="optional:"
value[26.107343]="Specify whether secretKeyRef's Secret or its key must be defined"
tag[26.107343]="1"
spec[26.108]="envFrom:"
value[26.108]="EnvFromSource represents the source of a set of ConfigMap"
tag[26.108]="0"
spec[26.1081]="configMapRef:"
value[26.1081]="ConfigMap to select from"
tag[26.1081]="0"
spec[26.10811]="name:"
value[26.10811]="ConfigMap name to select from"
tag[26.10811]="1"
spec[26.10812]="optional:"
value[26.10812]="Specify whether the ConfigMap must be defined(Boolean)"
tag[26.10812]="1"
spec[26.1082]="prefix:"
value[26.1082]="An optional identifier to prepend to each key in the ConfigMap"
tag[26.1082]="0"
spec[26.1083]="secretRef:"
value[26.1083]="*SecretEnvSource selects a Secret to populate the environment variables with."
tag[26.1083]="0"
spec[26.10831]="name:"
value[26.10831]="SecretEnvSource name"
tag[26.10831]="1"
spec[26.10832]="optional:"
value[26.10832]="Specify whether the Secret must be defined(Boolean)"
tag[26.10832]="1"
spec[26.109]="ports:"
value[26.109]="List of ports to expose from the container"
tag[26.109]="0"
spec[26.1091]="containerPort:"
value[26.1091]="Port number to expose on the pods IP address(o-65536)"
tag[26.1091]="1"
spec[26.1092]="hostIP:"
value[26.1092]="host IP to bind the external port to."
tag[26.1092]="1"
spec[26.1093]="hostPort:"
value[26.1093]="port number to expose on the host(If HostNetwork is specified"
tag[26.1093]=" this must match ContainerPort. Most containers do not need this)"
spec[26.1094]="name:"
value[26.1094]="Each named port in a pod must have a unique name"
tag[26.1094]="1"
spec[26.1095]="protocol:"
value[26.1095]="Protocol for port. (UDP/TCP/SCTP Defaults to "TCP")"
tag[26.1095]="1"
spec[26.110]="volumeMounts:"
value[26.110]="Pod volumes to mount into the container's filesystem"
tag[26.110]="0"
spec[26.1101]="mountPath:"
value[26.1101]="Path within the container at which the volume should be mounted. Must not contain ':'"
tag[26.1101]="1"
spec[26.1102]="name:"
value[26.1102]="NAme of the Volume"
tag[26.1102]="1"
spec[26.1103]="mountPropagation"
value[26.1103]="determines how mounts are propagated from the host to container and the other way around"
tag[26.1103]="1"
spec[26.1104]="readOnly:"
value[26.1104]="Mount volume value read-only if true"
tag[26.1104]=" read-write otherwise (false or unspecified). Defaults to false."
spec[26.1105]="subPath:"
value[26.1105]="Path within the volume from which the container's volume should be mounted.(Default to toor)"
tag[26.1105]="1"
spec[26.1106]="subPathExpr:"
value[26.1106]="Expanded path within the volume from which the container's volume should be mounted."
tag[26.1106]="1"
spec[26.112]="volumeDevices:"
value[26.112]="volumeDevices is the list of block devices to be used by the container."
tag[26.112]="0"
spec[26.1121]="devicePath:"
value[26.1121]="devicePath is the path inside of the container that the device will be mapped to"
tag[26.1121]="1"
spec[26.1122]="name:"
value[26.1122]="name must match the name of a persistentVolumeClaim in the pod"
tag[26.1122]="1"
spec[27.101]="resources:"
value[27.101]="Compute Resources required by this container"
tag[27.101]="0"
spec[27.1021]="claims:"
value[27.1021]="Claims lists the names of resources defined in spec.resourceClaims that are used by this container"
tag[27.1021]="0"
spec[27.10211]="name:"
value[27.10211]="Name must match the name of one entry in pod.spec.resourceClaims of the Pod where this field is used"
tag[27.10211]="1"
spec[27.103]="lifecycle:"
value[27.103]="Lifecycle describes actions that the management system should take in response to container lifecycle events"
tag[27.103]="0"
spec[27.1031]="limits:"
value[27.1031]="Limits describes the maximum amount of compute resources allowed"
tag[27.1031]="0"
spec[27.1031]="postStart:"
value[27.1031]="PostStart is called immediately after a container is created. If the handler fails the container is terminated and restarted according to its restart policy"
tag[27.1031]="0"
spec[27.1032]="preStop:"
value[27.1032]="PreStop is called immediately before a container is terminated due to an API request or management event such as liveness/startup probe failure"
tag[27.1032]="0"
spec[27.104]="terminationMessagePath:"
value[27.104]="Path at which the file to which the container's termination message will be written is mounted into the container's filesystem"
tag[27.104]="1"
spec[27.1041]="requests:"
value[27.1041]="Requests describes the minimum amount of compute resources required"
tag[27.1041]="0"
spec[27.105]="resizePolicy:"
value[27.105]="Resources resize policy for the container"
tag[27.105]="0"
spec[27.105]="terminationMessagePolicy:"
value[27.105]="Indicate how the termination message should be populated. File will use the contents of terminationMessagePath to populate the container status message on both success and failure."
tag[27.105]="1"
spec[27.1051]="resourceName:"
value[27.1051]="Name of the resource to which this resource resize policy applies(cpu/memory)"
tag[27.1051]="1"
spec[27.1052]="restartPolicy:"
value[27.1052]="Restart policy to apply when specified resource is resized"
tag[27.1052]="1"
spec[27.106]="livenessProbe:"
value[27.106]="Periodic probe of container liveness"
tag[27.106]="1"
spec[27.107]="readinessProbe:"
value[27.107]="Periodic probe of container service readiness"
tag[27.107]="1"
spec[27.108]="startupProbe:"
value[27.108]="StartupProbe indicates that the Pod has successfully initialized. If specified then no other probes are executed until this completes successfully"
tag[27.108]="1"
spec[27.109]="securityContext:"
value[27.109]="SecurityContext holds security configuration that will be applied to a container."
tag[27.109]="0"
spec[27.1091]="runAsUser:"
value[27.1091]="The UID to run the entrypoint of the container process"
tag[27.1091]="1"
spec[27.1092]="runAsNonRoot:"
value[27.1092]="Indicates that the container must run as a non-root user(Boolean)"
tag[27.1092]="1"
spec[27.1093]="runAsGroup:"
value[27.1093]="GID to run the entrypoint of the container process(int)"
tag[27.1093]="1"
spec[27.1094]="readOnlyRootFilesystem:"
value[27.1094]="Whether this container has a read-only root filesystem(Boolean)"
tag[27.1094]="1"
spec[27.1095]="procMount:"
value[27.1095]="type of proc mount to use for the containers(string)"
tag[27.1095]="1"
spec[27.1096]="privileged:"
value[27.1096]="Run container in privileged mode(priviliged)"
tag[27.1096]="1"
spec[27.1097]="allowPrivilegeEscalation:"
value[27.1097]="AllowPrivilegeEscalation controls whether a process can gain more privileges than its parent process(Boolean)"
tag[27.1097]="1"
spec[27.1098]="capabilities:"
value[27.1098]="Adds and removes POSIX capabilities from running containers."
tag[27.1098]="0"
spec[27.10981]="add:"
value[27.10981]="Adds POSIX capabilities"
tag[27.10981]="1"
spec[27.10982]="drop:"
value[27.10982]="remove POSIX capabilities"
tag[27.10982]="1"
spec[27.1099]="seccompProfile:"
value[27.1099]="SeccompProfile defines a pod/container's seccomp profile settings. Only one profile source may be set"
tag[27.1099]="0"
spec[27.10991]="type:"
value[27.10991]="type indicates which kind of seccomp profile will be applied(localhost/RuntimeDefault/Unconfined)"
tag[27.10991]="1"
spec[27.10992]="localhostProfile:"
value[27.10992]="localhostProfile indicates a profile defined in a file on the node should be used"
tag[27.10992]="1"
spec[27.110]="stdin:"
value[27.110]="Whether this container should allocate a buffer for stdin in the container runtime. If this is not set(Boolean)"
tag[27.110]="1"
spec[27.1100]="seLinuxOptions:"
value[27.1100]="SELinux context to be applied to the container"
tag[27.1100]="0"
spec[27.11001]="level:"
value[27.11001]="Level is SELinux level label that applies to the container(string)"
tag[27.11001]="1"
spec[27.11002]="role:"
value[27.11002]="Role is a SELinux role label that applies to the container(string)"
tag[27.11002]="1"
spec[27.11003]="type:"
value[27.11003]="Type is a SELinux type label that applies to the container(string)"
tag[27.11003]="1"
spec[27.11004]="user:"
value[27.11004]="User is a SELinux user label that applies to the container(string)"
tag[27.11004]="1"
spec[27.1101]="windowsOptions:"
value[27.1101]="WindowsSecurityContextOptions contain Windows-specific options and credentials"
tag[27.1101]="1"
spec[27.11011]="hostProcess:"
value[27.11011]="HostProcess determines if a container should be run as a 'Host Process' container(Boolean)"
tag[27.11011]="1"
spec[27.11012]="runAsUserName:"
value[27.11012]="UserName in Windows to run the entrypoint of the container process(string)"
tag[27.11012]="1"
spec[27.120]="tty:"
value[27.120]="Whether this container should allocate a TTY for itself then also requires 'stdin' to be true. Default is false"
tag[27.120]="1"
spec[29.100]="volumes:"
