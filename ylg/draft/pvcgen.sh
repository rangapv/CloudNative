#!/bin/bash
#author: rangapv@yahoo.com 02-05-23
#USUAGE: ./pvcgen.sh gen (will generate the Skeletal YAML pvc.yaml and pvcv.yaml a human readable file to fill values)
#USUAGE: ./pvcgen.sh (SAME as above ....will generate the Skeletal YAML pvc.yaml and pvcv.yaml a human readable file to fill values)
#USUAGE: ./pvcgen.sh fill (The program takes the FILLED pvcv.yaml file generated ealier from above step and popluates the Skeletal pvc.yaml with pv claim values)
