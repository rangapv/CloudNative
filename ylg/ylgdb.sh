...
tag[4.711]="0"
spec[4.7111]="- name:"
value[4.7111]="The name for the init container"
tag[4.7111]="1"
spec[4.71111]="image:"
value[4.71111]="The init container image"
tag[4.71111]="1"
spec[4.71112]="command:"
value[4.71112]="The command to be executed for the init container"
tag[4.71112]="1"
spec[4.71113]="volumeMounts:"
value[4.71113]="The volume mounts for the init container"
tag[4.71113]="0"
spec[4.71114]="- name:"
value[4.71114]="Name of the volume mount in init container in the format mountpoints;mountpath "
tag[4.71114]="1"
spec[4.711141]="mountPath:"
value[4.711141]="The mountpath for the volume mount of init container"
tag[4.711141]="0"
