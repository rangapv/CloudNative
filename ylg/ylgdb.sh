...
tag[27.103632]="1"
spec[28.100]="epheramalContainers:"
value[28.100]="The epheramal"
tag[28.100]="0"
spec[28.101]="- name:"
...
tag[39.421]="0"
spec[39.4211]="type:"
value[39.4211]="How to match(Exact/PathPrefix/Regular-expresssion)"
tag[39.4211]="1"
spec[39.4212]="value:"
value[39.4212]="The path string value to match"
tag[39.4212]="1"
spec[39.422]="headers:"
...
tag[39.431]="1"
spec[39.432]="requestHeaderModifier:"
value[39.432]="defines a schema for a filter that modifies request headers"
tag[39.432]="1"
spec[39.4321]="set:"
value[39.4321]="Set overwrites the request with the given header in requestHeaderModifier"
tag[39.4321]="0"
spec[39.43211]="- name:"
value[39.43211]="HTTP Header to be matched for set in requestHeaderModifier filter for httpRoute"
tag[39.43211]="1"
spec[39.432111]="value:"
value[39.432111]="value of HTTP Header to be matched for set in requestHeaderModifier filter for httpRoute"
tag[39.432111]="1"
spec[39.4322]="add:"
value[39.4322]="Add adds the given header to the request before the action in requestHeaderModifier "
tag[39.4322]="0"
spec[39.43221]="- name:"
value[39.43221]="HTTP Header to be matched for add in requestHeaderModifier filter for httpRoute"
tag[39.43221]="1"
spec[39.432211]="value:"
value[39.432211]="value of HTTP Header to be matched for add in requestHeaderModifier filter for httpRoute"
tag[39.432211]="1"
spec[39.4323]="remove:"
value[39.4323]="the given header(s) from the HTTP request before the action for requestHeaderModifier in filters of httpRouter rules"
tag[39.4323]="1"
spec[39.433]="responseHeaderModifier:"
value[39.433]="defines a schema for a filter that modifies response headers"
tag[39.433]="1"
spec[39.4331]="set:"
value[39.4331]="Set overwrites the request with the given header in responseHeaderModifier"
tag[39.4331]="0"
spec[39.43311]="- name:"
value[39.43311]="HTTP Header to be matched for set in responseHeaderModifier filter for httpRoute"
tag[39.43311]="1"
spec[39.433111]="value:"
value[39.433111]="value of HTTP Header to be matched for set in responseHeaderModifier filter for httpRoute"
tag[39.433111]="1"
spec[39.4332]="add:"
value[39.4332]="Add adds the given header to the request before the action in responseHeaderModifier "
tag[39.4332]="0"
spec[39.43321]="- name:"
value[39.43321]="HTTP Header to be matched for add in responseHeaderModifier filter for httpRoute"
tag[39.43321]="1"
spec[39.433211]="value:"
value[39.433211]="value of HTTP Header to be matched for add in responseHeaderModifier filter for httpRoute"
tag[39.433211]="1"
spec[39.4333]="remove:"
value[39.4333]="the given header(s) from the HTTP request before the action for responseHeaderModifier in filters of httpRouter rules"
tag[39.4333]="1"
spec[39.434]="requestMirror:"
value[39.434]="Requests are sent to the specified destination"
tag[39.434]="1"
spec[39.4341]="backendRef:"
value[39.4341]="BackendRef references a resource where mirrored requests are sent"
tag[39.4341]="0"
spec[39.43411]="-name:"
value[39.43411]="the name of the referent requestMirror"
tag[39.43411]="1"
spec[39.434111]="kind:"
value[39.434111]="Kubernetes resource kind of the referent requestMirror"
tag[39.434111]="1"
spec[39.434112]="group:"
value[39.434112]="Group is the group of the referent requestMirror"
tag[39.434112]="1"
spec[39.434113]="port:"
value[39.434113]="specifies the destination port number to use for this resource of requestMirror"
tag[39.434113]="1"
spec[39.434114]="namespace:"
value[39.434114]="namespace of the backend requestMirror"
tag[39.434114]="1"
spec[39.435]="requestRedirect:"
value[39.435]="RequestRedirect defines a schema for a filter that responds to the request with an HTTP redirection"
tag[39.435]="1"
spec[39.4351]="path:"
value[39.4351]="Path defines a path rewrite in httpRoute requestRedirect filters"
tag[39.4351]="1"
spec[39.43511]="replaceFullPath:"
value[39.43511]="ReplaceFullPath specifies the value with which to replace the full path of a request during a rewrite or redirec in httpRoute requestRedirect"
tag[39.43511]="1"
spec[39.43512]="replacePrefixMatch:"
value[39.43512]="ReplacePrefixMatch specifies the value with which to replace the prefix match of a request in httproute requestRedirect filters"
tag[39.43512]="1"
spec[39.43513]="type:"
value[39.43513]="type of replaceFullPath/replacePrefixMatch in Requestredirect"
tag[39.43513]="1"
spec[39.4353]="port:"
value[39.4353]=" port to be used in the value of the Location header in the response requestRedirect filter"
tag[39.4353]="1"
spec[39.4354]="hostname:"
value[39.4354]="hostname to be used in the value of the Location header in the response requestRedirect filter"
tag[39.4354]="1"
spec[39.4355]="scheme:"
value[39.4355]=" is the scheme to be used in the value of the Location header in the response requestRedirect filter"
tag[39.4355]="1"
spec[39.4356]="statusCode:"
value[39.4356]="HTTP status code to be used in response for requestRedirect filter"
tag[39.4356]="1"
spec[39.436]="urlRewrite:"
value[39.436]="URLRewrite defines a schema for a filter that modifies a request during forwarding"
tag[39.436]="1"
spec[39.4361]="path:"
value[39.4361]="Path defines a path rewrite in httpRoute URLRewrite filters"
tag[39.4361]="1"
spec[39.43611]="type:"
value[39.43611]="type of replaceFullPath/replacePrefixMatch in URLRwrite"
tag[39.43611]="1"
spec[39.43612]="replaceFullPath:"
value[39.43612]="ReplaceFullPath specifies the value with which to replace the full path of a request during a rewrite or redirec in httpRoute URLRewrite filter"
tag[39.43612]="1"
spec[39.43613]="replacePrefixMatch:"
value[39.43613]="ReplacePrefixMatch specifies the value with which to replace the prefix match of a request in httproute URLRewrite filters"
tag[39.43613]="1"
spec[39.4362]="hostname:"
value[39.4362]="Hostname is the value to be used to replace the Host header value during forwarding in httproute URLRewrite filters"
tag[39.4362]="1"
spec[39.437]="extensionRef:"
value[39.437]="implementation-specific extension to the filter behavior"
tag[39.437]="1"
spec[39.4371]="- name:"
value[39.4371]=" is the name of the referent extensionRef of filters in httpRoute"
tag[39.4371]="1"
spec[39.43711]="kind:"
value[39.43711]=" kind of the referent extensionRef of filters in httpRoute"
tag[39.43711]="1"
spec[39.43712]="group:"
value[39.43712]=" is the group of the referent extensionRef of filters in httpRoute"
tag[39.43712]="1"
