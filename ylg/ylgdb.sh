...
tag[7.1412]="1"
spec[9]="spec:"
value[9]="spec for StorageClass in aws/gcp/azure"
tag[9]="0"
spec[9.1]="provisioner:"
value[9.1]="spec of provisioner for aws/gcp/azure"
tag[9.1]="1"
spec[9.2]="parameters:"
value[9.2]="spec parameters of provisioner for aws/gcp/azure"
tag[9.2]="1"
spec[9.4]="allowVolumeExpansion:"
value[9.4]="shows whether the storage class allow volume expand"
tag[9.4]="1"
spec[9.5]="mountOptions:"
value[9.5]="controls the mountOptions for dynamically provisioned PersistentVolumes of this storage class"
tag[9.5]="1"
spec[9.6]="reclaimPolicy:"
value[9.6]="controls the reclaimPolicy for dynamically provisioned PersistentVolumes of this storage class/defaults to Delete"
tag[9.6]="1"
spec[9.7]="volumeBindingMode:"
value[9.7]="indicates how PersistentVolumeClaims should be provisioned and bound"
tag[9.7]="1"
spec[9.8]="allowedTopologies:"
value[9.8]="restrict the node topologies where volumes can be dynamically provisioned"
tag[9.8]="0"
spec[9.81]="matchLabelExpressions:"
value[9.81]="topology selector requirement is a selector that matches given label"
tag[9.81]="0"
spec[9.811]="key:"
value[9.811]="label key that the selector applies to"
tag[9.811]="1"
spec[9.812]="values:"
value[9.812]="One value must match the label to be selected"
tag[9.812]="1"
spec[10]="stringData:"
...
tag[39.437112]="1"
spec[42]="spec:"
value[42]="Spec definition for Issuer/Cluster-Issuer for a Cert-Manager in ACME verification"
tag[42]="0"
spec[42.1]="acme:"
...
tag[42.14]="0"
spec[42.151]="- http01:"
value[42.151]="The HTTP solver that needs to be deployed"
tag[42.151]="0"
spec[42.15111]="ingress:"
value[42.15111]="ingress based HTTP01 challenge solver will solve challenges by creating or modifying Ingress resources in order to route requests"
tag[42.15111]="0"
spec[42.151111]="serviceType:"
value[42.151111]="Supported values are NodePort or ClusterIP"
tag[42.151111]="1"
spec[42.151112]="ingressClassName:"
value[42.151112]="The ingressClassName for ingress may be specified"
tag[42.151112]="1"
spec[42.151113]="class:"
value[42.151113]="The class for ingress may be specified"
tag[42.151113]="1"
spec[42.151114]="name:"
value[42.151114]="The name for ingress may be specified"
tag[42.151114]="1"
spec[42.151115]="podTemplate:"
value[42.151115]="pod template used to configure the ACME challenge solver pods used for HTTP01 challenges"
tag[42.151115]="1"
spec[42.1511151]="metadata:"
value[42.1511151]="ObjectMeta overrides for the pod used to solve HTTP01 challenges"
tag[42.1511151]="0"
spec[42.15111511]="annotations:"
value[42.15111511]="Annotations that should be added to the create ACME HTTP01 solver pods"
tag[42.15111511]="1"
spec[42.15111512]="labels:"
value[42.15111512]="Labels that should be added to the created ACME HTTP01 solver pods"
tag[42.15111512]="1"
spec[42.1511152]="spec:"
value[42.1511152]="defines overrides for the HTTP01 challenge solver pod"
tag[42.1511152]="0"
spec[42.15111521]="nodeSelector:"
value[42.15111521]="Selector which must match a node’s labels for the pod to be scheduled on that node"
tag[42.15111521]="1"
spec[42.15111522]="affinity:"
value[42.15111522]="the pod’s scheduling constraints"
tag[42.15111522]="1"
spec[42.15111523]="tolerations:"
value[42.15111523]="the pod’s tolerations"
tag[42.15111523]="1"
spec[42.15111524]="priorityClassName:"
value[42.15111524]="the pod’s priorityClassName"
tag[42.15111524]="1"
spec[42.15111525]="serviceAccountName:"
value[42.15111525]="the pod’s service account"
tag[42.15111525]="1"
spec[42.15111526]="imagePullSecrets:"
value[42.15111526]="the pod’s imagePullSecrets"
tag[42.15111526]="1"
spec[42.151116]="ingressTemplate:"
value[42.151116]="Optional ingress template used to configure the ACME challenge solver ingress used for HTTP01 challenges"
tag[42.151116]="0"
spec[42.1511161]="metadata:"
value[42.1511161]="ObjectMeta overrides for the ingress used to solve HTTP01 challenges"
tag[42.1511161]="0"
spec[42.15111611]="annotations:"
value[42.15111611]="Annotations that should be added to the created ACME HTTP01 solver ingress"
tag[42.15111611]="1"
spec[42.15111612]="labels:"
value[42.15111612]="Labels that should be added to the created ACME HTTP01 solver ingress"
tag[42.15111612]="1"
spec[42.15112]="gatewayHTTPRoute:"
value[42.15112]="Gateway API is a sig-network community API that models service networking in Kubernetes(experimental)"
tag[42.15112]="0"
spec[42.151121]="serviceType:"
value[42.151121]="service type for Kubernetes solver service. Supported values are NodePort or ClusterIP"
tag[42.151121]="1"
spec[42.151122]="labels:"
value[42.151122]=" Custom labels that will be applied to HTTPRoutes created by cert-manager while solving HTTP-01 challenges"
tag[42.151122]="1"
spec[42.151123]="parentRefs:"
value[42.151123]="Generally the parentRef references a Gateway"
tag[42.151123]="1"
spec[42.161]="- selector:"
value[42.161]="selects a set of DNSNames on the Certificate resource that should be solved using this challenge solver"
tag[42.161]="0"
spec[42.16111]="matchLabels:"
value[42.16111]="label selector that is used to refine the set of certificate’s that this challenge solver will apply to"
tag[42.16111]="1"
spec[42.16112]="dnsNames:"
value[42.16112]="List of DNSNames that this solver will be used to solve"
tag[42.16112]="1"
spec[42.16113]="dnsZones:"
value[42.16113]="List of DNSZones that this solver will be used to solve"
tag[42.16113]="1"
spec[42.181]="- dns01:"
value[42.181]="Configures cert-manager to attempt to complete authorizations by performing the DNS01 challenge flow"
tag[42.181]="0"
spec[42.18111]="cnameStrategy:"
value[42.18111]="CNAMEStrategy configures how the DNS01 provider should handle CNAME records when found in DNS zones"
tag[42.18111]="0"
spec[42.181111]="matchLabels:"
value[42.181111]="label selector that is used to refine the set of certificate’s that this challenge solver will apply to"
tag[42.181111]="1"
spec[42.181112]="dnsNames:"
value[42.181112]="List of DNSNames that this solver will be used to solve"
tag[42.181112]="1"
spec[42.181113]="dnsZones:"
value[42.181113]="List of DNSZones that this solver will be used to solve"
tag[42.181113]="1"
spec[42.18112]="akamai:"
value[42.18112]="Akamai DNS zone management API to manage DNS01 challenge records"
tag[42.18112]="0"
spec[42.181121]="serviceConsumerDomain:"
value[42.181121]="service consumer domain for akami"
tag[42.181121]="1"
spec[42.181122]="clientTokenSecretRef:"
value[42.181122]="client token secret ref for akami dns solver"
tag[42.181122]="0"
spec[42.1811221]="name:"
value[42.1811221]="name client token secret ref for akami dns"
tag[42.1811221]="1"
spec[42.1811222]="key:"
value[42.1811222]="key clinet token secret ref for akami key of the entry in the Secret resource’s data field to be used"
tag[42.1811222]="1"
spec[42.181123]="clientSecretSecretRef:"
value[42.181123]="Azure clinet secret ref"
tag[42.181123]="0"
spec[42.1811231]="name:"
value[42.1811231]="name client secret secret ref for akami dns"
tag[42.1811231]="1"
spec[42.1811232]="key:"
value[42.1811232]="key clinet secret secret ref for akami key of the entry in the Secret resource’s data field to be used"
tag[42.1811232]="1"
spec[42.181124]="accessTokenSecretRef:"
value[42.181124]="access token secre ref for akami"
tag[42.181124]="0"
spec[42.1811241]="name:"
value[42.1811241]="name client access token secret ref for akami dns"
tag[42.1811241]="1"
spec[42.1811242]="key:"
value[42.1811242]="key clinet access token secret ref for akami key of the entry in the Secret resource’s data field to be used"
tag[42.1811242]="1"
spec[42.18113]="cloudDNS:"
value[42.18113]="the Google Cloud DNS API to manage DNS01 challenge records"
tag[42.18113]="0"
spec[42.181131]="project:"
value[42.181131]="the Google Cloud DNS Project"
tag[42.181131]="1"
spec[42.181132]="serviceAccountSecretRef:"
value[42.181132]=" service account secret for Google CLoud DNS"
tag[42.181132]="0"
spec[42.1811321]="name:"
value[42.1811321]="name Google Cloud account secret ref for GCP dns"
tag[42.1811321]="1"
spec[42.1811322]="key:"
value[42.1811322]="key clinet access token secret ref for akami key of the entry in the Secret resource’s data field to be used"
tag[42.1811322]="1"
spec[42.181133]="hostedZoneName:"
value[42.181133]="HostedZoneName for GCP is an optional field that tells cert-manager in which Cloud DNS zone the challenge record has to be created"
tag[42.181133]="1"
spec[42.18114]="cloudflare:"
value[42.18114]="Cloudflare API to manage DNS01 challenge records"
tag[42.18114]="0"
spec[42.181141]="email:"
value[42.181141]="Cloudflare Email of the account only required when using API key based authentication"
tag[42.181141]="1"
spec[42.181142]="apiKeySecretRef:"
value[42.181142]="API key to use to authenticate with Cloudflare"
tag[42.181142]="0"
spec[42.1811421]="name:"
value[42.1811421]="name CloudFlare API account secret ref for GCP dns"
tag[42.1811421]="1"
spec[42.1811422]="key:"
value[42.1811422]="key CloudFlare API account secretclinet access token secret ref entry in the Secret resource’s data field to be used"
tag[42.1811422]="1"
spec[42.181143]="apiTokenSecretRef:"
value[42.181143]="API token used to authenticate with Cloudflare"
tag[42.181143]="0"
spec[42.1811431]="name:"
value[42.1811431]="name CloudFlare API token secret ref for GCP dns"
tag[42.1811431]="1"
spec[42.1811432]="key:"
value[42.1811432]="key CloudFlare API token secretclient access token secret ref entry in the Secret resource’s data field to be used"
tag[42.1811432]="1"
spec[42.18115]="route53:"
value[42.18115]="the AWS Route53 API to manage DNS01 challenge records"
tag[42.18115]="0"
spec[42.181151]="accessKeyID:"
value[42.181151]="AccessKeyID is used for authentication. Cannot be set when SecretAccessKeyID is set"
tag[42.181151]="1"
spec[42.181152]="accessKeyIDSecretRef:"
value[42.181152]="SecretAccessKey is used for authentication. If set pull the AWS access key ID from a key within a Kubernetes Secret"
tag[42.181152]="0"
spec[42.1811521]="name:"
value[42.1811521]="name AWS route53 access token secret ref dns"
tag[42.1811521]="1"
spec[42.1811522]="key:"
value[42.1811522]="key AWS toute53 secret client access token secret ref entry in the Secret resource’s data field to be used"
tag[42.1811522]="1"
spec[42.181153]="secretAccessKeySecretRef:"
value[42.181153]="SecretAccessKey is used for authentication. If neither the Access Key nor Key ID are set then we fall-back to using env vars shared credentials file or AWS Instance metadata"
tag[42.181153]="0"
spec[42.1811531]="name:"
value[42.1811531]="name of AWS route53 secret access key secret ref dns"
tag[42.1811531]="1"
spec[42.1811532]="key:"
value[42.1811532]="key of AWS toute53 secret client access key secret ref entry in the Secret resource’s data field to be used"
tag[42.1811532]="1"
spec[42.181154]="role:"
value[42.181154]="Role is a Role ARN which the Route53 provider will assume using either the explicit credentials AccessKeyID/SecretAccessKey or the inferred credentials from environment variables"
tag[42.181154]="1"
spec[42.181155]="hostedZoneID:"
value[42.181155]="AWS the provider will manage only this zone in Route53 and will not do an lookup using the route53-ListHostedZonesByName api call"
tag[42.181155]="1"
spec[42.181156]="region:"
value[42.181156]="Always set the AWS region when using AccessKeyID and SecretAccessKey"
tag[42.181156]="1"
spec[42.18117]="acmeDNS:"
value[42.18117]=" the ACME DNS API to manage DNS01 challenge records"
tag[42.18117]="0"
spec[42.181171]="host:"
value[42.181171]="ACEM host name"
tag[42.181171]="1"
spec[42.181172]="accountSecretRef:"
value[42.181172]="ACME DNS account ref"
tag[42.181172]="0"
spec[42.1811721]="name:"
value[42.1811721]="name of ACME account secret key secret ref dns"
tag[42.1811721]="1"
spec[42.1811722]="key:"
value[42.1811722]="key of ACMEsaccount secret ref entry in the Secret resource’s data field to be used"
tag[42.1811722]="1"
spec[42.18118]="webhook:"
value[42.18118]="Configure an external webhook based DNS01 challenge solver to manage DNS01 challenge records"
tag[42.18118]="0"
spec[42.181181]="groupName:"
value[42.181181]="API group name that should be used when POSTing ChallengePayload resources to the webhook apiserver"
tag[42.181181]="1"
spec[42.181182]="solverName:"
value[42.181182]="name of the solver to use as defined in the webhook provider implementation(like cloudflare)"
tag[42.181182]="1"
spec[42.181183]="config:"
value[42.181183]="Additional configuration that should be passed to the webhook apiserver when challenges are processed"
tag[42.181183]="1"
spec[42.18119]="azureDNS:"
value[42.18119]="the Microsoft Azure DNS API to manage DNS01 challenge records"
tag[42.18119]="0"
spec[42.181191]="clientID:"
value[42.181191]="Azure clinetID"
tag[42.181191]="1"
spec[42.181192]="clientSecretSecretRef:"
value[42.181192]="Azure cline tsecret ref"
tag[42.181192]="0"
spec[42.1811921]="name:"
value[42.1811921]="name of Azure secret secret key secret ref dns"
tag[42.1811921]="1"
spec[42.1811922]="key:"
value[42.1811922]="key of Azure secret secret ref entry in the Secret resource’s data field to be used"
tag[42.1811922]="1"
spec[42.181193]="subscriptionID:"
value[42.181193]="ID of the Azure subscription for DNS challenge"
tag[42.181193]="1"
spec[42.181194]="tenantID:"
value[42.181194]="specifying ClientID and ClientSecret then this field is also needed gor Azure DNS solver"
tag[42.181194]="1"
spec[42.181195]="resourceGroupName:"
value[42.181195]="Azure resource group the DNS zone is located in DNS solver"
tag[42.181195]="1"
spec[42.181196]="hostedZoneName:"
value[42.181196]="name of the DNS zone that should be used in Azure DNS solver"
tag[42.181196]="1"
spec[42.181197]="environment:"
value[42.181197]="name of the Azure environment for Azure DNS solver(hint AzurePublicCloud)"
tag[42.181197]="1"
spec[42.181198]="managedIdentity:"
value[42.181198]="managed identity configuration for Azure DNS solver"
tag[42.181198]="0"
spec[42.1811981]="clientID:"
value[42.1811981]="client ID of the managed identity in Azure DNS solver"
tag[42.1811981]="1"
spec[42.1811982]="resourceID:"
value[42.1811982]="resource ID of the managed identity Azure DNS solver"
tag[42.1811982]="1"
spec[42.21]="disableAccountKeyGeneration:"
value[42.21]="Enables or disables generating a new ACME account key(boolean)"
tag[42.21]="1"
spec[42.22]="enableDurationFeature:"
value[42.22]="Enables requesting a Not After date on certificates that matches the duration of the certificate"
tag[42.22]="1"
spec[42.23]="externalAccountBinding:"
value[42.23]="reference to a CA external account of the ACME server"
tag[42.23]="0"
spec[42.231]="keyID:"
value[42.231]="ID of the CA key that the External Account is bound to in ACME server"
tag[42.231]="1"
spec[42.232]="keySecretRef:"
value[42.232]="Secret Key Selector referencing a data item in a Kubernetes Secret which holds the symmetric MAC key of the External Account Binding in ACME server"
tag[42.232]="0"
spec[42.2321]="name:"
value[42.2321]="Name of the resource being referred to for loacalObjecrRef of keySecretRef in ACME server"
tag[42.2321]="1"
spec[42.2322]="key:"
value[42.2322]="key of the entry in the Secret resource’s data field to be used of keysecretRef in ACME server"
tag[42.2322]="1"
spec[42.233]="keyAlgorithm:"
value[42.233]="depreceated key algorithm hardcoded in golang acme"
tag[42.233]="0"
spec[42.24]="skipTLSVerify:"
value[42.24]="Enables or disables validation of the ACME server TLS certificate(boolean)"
tag[42.24]="1"
spec[42.25]="caBundle:"
value[42.25]="Base64-encoded bundle of PEM CAs which can be used to validate the certificate chain presented by the ACME server"
tag[42.25]="1"
spec[42.26]="preferredChain:"
value[42.26]="PreferredChain is the chain to use if the ACME server outputs multiple(string)"
tag[42.26]="1"
spec[50]="spec:"
value[50]="Spec for IngressClass"
tag[50]="0"
spec[50.1]="controller:"
value[50.1]="name of the controller that should handle this class"
tag[50.1]="1"
spec[50.2]="parameters:"
value[50.2]="optional additional config for the controller"
tag[50.2]="0"
spec[50.21]="kind:"
value[50.21]="type of resource being referenced for ingress parameters"
tag[50.21]="1"
spec[50.22]="name:"
value[50.22]="name of the reource being referenced for ingress parameters"
tag[50.22]="1"
spec[50.23]="apiGroup:"
value[50.23]="group of ingress parameters being referenced"
tag[50.23]="1"
spec[50.24]="namespace:"
value[50.24]="namespace of ingress parameters being referenced"
tag[50.24]="1"
spec[50.25]="scope:"
value[50.25]="either Cluster/Namespace scope"
tag[50.25]="1"
spec[51]="spec:"
value[51]="Spec for the Ingress"
tag[51]="0"
spec[51.1]="defaultBackend:"
value[51.1]="the backend that should handle the request if no rules"
tag[51.1]="1"
spec[51.2]="ingressClassName:"
value[51.2]="name of the IngressClass resource(deprecated)"
tag[51.2]="1"
spec[51.3]="rules:"
value[51.3]="The list of host rules to configure ingress"
tag[51.3]="0"
spec[51.4]="- host:"
value[51.4]="FQDN"
tag[51.4]="1"
spec[51.41]="http:"
value[51.41]="http rule value"
tag[51.41]="0"
spec[51.411]="paths:"
value[51.411]="paths is a collection of paths that map requests to backends"
tag[51.411]="0"
spec[51.412]="- backend:"
value[51.412]="referenced service endpoint to which the traffic will be forwarded to"
tag[51.412]="1"
spec[51.41211]="resource:"
value[51.41211]="Resource if specified it needs Name as well as Port exclusive to setting service"
tag[51.41211]="1"
spec[51.41212]="service:"
value[51.41212]="backend service mutually exclusive to setting resource"
tag[51.41212]="0"
spec[51.412121]="name:"
value[51.412121]="name of the service in ingress namespace"
tag[51.412121]="1"
spec[51.412122]="port:"
value[51.412122]="port name or number for IngressServiceBackend"
tag[51.412122]="0"
spec[51.4121221]="name:"
value[51.4121221]="name of the port exclusive to setting number"
tag[51.4121221]="1"
spec[51.4121222]="number:"
value[51.4121222]="number of the port on service exclusive to setting name"
tag[51.4121222]="1"
spec[51.4123]="pathType:"
value[51.4123]="interpretation of the Path matching is up to the IngressClass. Implementations can treat this as a separate PathType or treat it identically to Prefix or Exact path types"
tag[51.4123]="1"
spec[51.4124]="path:"
value[51.4124]="path of an incoming request"
tag[51.4124]="1"
spec[51.5]="tls:"
value[51.5]="tls represents the TLS configuration"
tag[51.5]="0"
spec[51.6]="- hosts:"
value[51.6]="list of hosts inluded in the TLS certificate"
tag[51.6]="1"
spec[51.61]="secretName:"
value[51.61]="name of secret used to terminate TLS"
tag[51.61]="1"
