...
tag[11.511211]="1"
spec[20.10]="template:"
value[20.10]="template"
tag[20.10]="0"
spec[20.101]="metadata:"
value[20.101]="The Pod metadata like labels"
tag[20.101]="0"
spec[20.1011]="labels:"
value[20.1011]="The label for the Pod if any"
tag[20.1011]="1"
spec[20.10111]="app:"
value[20.10111]="The app name for the Pod if any"
tag[20.10111]="1"
spec[20.20]="spec:"
...
tag[26.10191]="1"
spec[26.10192]="mountPath:"
value[26.10192]="Path within the container at which the volume should be mounted. Must not contain colon"
tag[26.10192]="0"
