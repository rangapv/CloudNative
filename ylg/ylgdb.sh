...
value[42.1512]="The ingressClassName for ingress may be specified"
tag[42.1512]="1"
spec[42.1513]="class:"
value[42.1513]="The class for ingress may be specified"
tag[42.1513]="1"
spec[42.1514]="name:"
value[42.1514]="The name for ingress may be specified"
tag[42.1514]="1"
...
tag[42.151526]="1"
spec[42.1516]="ingressTemplate:"
value[42.1516]="Optional ingress template used to configure the ACME challenge solver ingress used for HTTP01 challenges"
tag[42.1516]="0"
spec[42.15161]="metadata:"
value[42.15161]="ObjectMeta overrides for the ingress used to solve HTTP01 challenges"
tag[42.15161]="0"
spec[42.151611]="annotations:"
value[42.151611]="Annotations that should be added to the created ACME HTTP01 solver ingress"
tag[42.151611]="1"
spec[42.151612]="labels:"
value[42.151612]="Labels that should be added to the created ACME HTTP01 solver ingress"
tag[42.151612]="1"
...
tag[42.1523]="1"
spec[42.19]="selector:"
value[42.19]="selects a set of DNSNames on the Certificate resource that should be solved using this challenge solver"
tag[42.19]="0"
spec[42.191]="matchLabels:"
value[42.191]="label selector that is used to refine the set of certificate’s that this challenge solver will apply to"
tag[42.191]="1"
spec[42.192]="dnsNames:"
value[42.192]="List of DNSNames that this solver will be used to solve"
tag[42.192]="1"
spec[42.193]="dnsZones:"
value[42.193]="List of DNSZones that this solver will be used to solve"
tag[42.193]="1"
...
value[42.232]="Secret Key Selector referencing a data item in a Kubernetes Secret which holds the symmetric MAC key of the External Account Binding in AC<ME server"
tag[42.232]="0"
spec[42.2321]="LocalObjectReference:"
value[42.2321]="name of the Secret resource being referred to in ACME server"
tag[42.2321]="0"
spec[42.23211]="name:"
value[42.23211]="Name of the resource being referred to for loacalObjecrRef of keySecretRef in ACME server"
tag[42.23211]="1"
spec[42.2322]="key:"
