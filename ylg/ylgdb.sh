...
tag[39.43211]="0"
spec[39.432111]="- name:"
value[39.432111]="HTTP Header to be matched for set in requestHeaderModifier filter for httpRoute"
tag[39.432111]="1"
...
tag[39.4321111]="1"
spec[39.43221]="add:"
value[39.43221]="Add adds the given header to the request before the action in requestHeaderModifier "
tag[39.43221]="0"
spec[39.432211]="- name:"
value[39.432211]="HTTP Header to be matched for add in requestHeaderModifier filter for httpRoute"
tag[39.432211]="1"
spec[39.4322111]="value:"
value[39.4322111]="value of HTTP Header to be matched for add in requestHeaderModifier filter for httpRoute"
tag[39.4322111]="1"
spec[39.43231]="remove:"
value[39.43231]="the given header(s) from the HTTP request before the action for requestHeaderModifier in filters of httpRouter rules"
tag[39.43231]="1"
...
tag[39.43311]="0"
spec[39.433111]="- name:"
value[39.433111]="HTTP Header to be matched for set in responseHeaderModifier filter for httpRoute"
tag[39.433111]="1"
...
tag[39.4331111]="1"
spec[39.43321]="add:"
value[39.43321]="Add adds the given header to the request before the action in responseHeaderModifier "
tag[39.43321]="0"
spec[39.433211]="- name:"
value[39.433211]="HTTP Header to be matched for add in responseHeaderModifier filter for httpRoute"
tag[39.433211]="1"
spec[39.4332111]="value:"
value[39.4332111]="value of HTTP Header to be matched for add in responseHeaderModifier filter for httpRoute"
tag[39.4332111]="1"
spec[39.43331]="remove:"
value[39.43331]="the given header(s) from the HTTP request before the action for responseHeaderModifier in filters of httpRouter rules"
tag[39.43331]="1"
...
tag[39.4341111]="1"
spec[39.4341121]="group:"
value[39.4341121]="Group is the group of the referent requestMirror"
tag[39.4341121]="1"
spec[39.4341131]="port:"
value[39.4341131]="specifies the destination port number to use for this resource of requestMirror"
tag[39.4341131]="1"
spec[39.4341141]="namespace:"
value[39.4341141]="namespace of the backend requestMirror"
tag[39.4341141]="1"
...
tag[39.43511]="1"
spec[39.435111]="replaceFullPath:"
value[39.435111]="ReplaceFullPath specifies the value with which to replace the full path of a request during a rewrite or redirec in httpRoute requestRedirect"
tag[39.435111]="1"
spec[39.435121]="replacePrefixMatch:"
value[39.435121]="ReplacePrefixMatch specifies the value with which to replace the prefix match of a request in httproute requestRedirect filters"
tag[39.435121]="1"
spec[39.435131]="type:"
value[39.435131]="type of replaceFullPath/replacePrefixMatch in Requestredirect"
tag[39.435131]="1"
spec[39.43531]="port:"
value[39.43531]=" port to be used in the value of the Location header in the response requestRedirect filter"
tag[39.43531]="1"
spec[39.43541]="hostname:"
value[39.43541]="hostname to be used in the value of the Location header in the response requestRedirect filter"
tag[39.43541]="1"
spec[39.43551]="scheme:"
value[39.43551]=" is the scheme to be used in the value of the Location header in the response requestRedirect filter"
tag[39.43551]="1"
spec[39.43561]="statusCode:"
value[39.43561]="HTTP status code to be used in response for requestRedirect filter"
tag[39.43561]="1"
spec[39.4361]="urlRewrite:"
value[39.4361]="URLRewrite defines a schema for a filter that modifies a request during forwarding"
tag[39.4361]="0"
spec[39.43611]="path:"
value[39.43611]="Path defines a path rewrite in httpRoute URLRewrite filters"
tag[39.43611]="1"
spec[39.436111]="type:"
value[39.436111]="type of replaceFullPath/replacePrefixMatch in URLRwrite"
tag[39.436111]="1"
spec[39.436121]="replaceFullPath:"
value[39.436121]="ReplaceFullPath specifies the value with which to replace the full path of a request during a rewrite or redirec in httpRoute URLRewrite filter"
tag[39.436121]="1"
spec[39.436131]="replacePrefixMatch:"
value[39.436131]="ReplacePrefixMatch specifies the value with which to replace the prefix match of a request in httproute URLRewrite filters"
tag[39.436131]="1"
spec[39.43621]="hostname:"
value[39.43621]="Hostname is the value to be used to replace the Host header value during forwarding in httproute URLRewrite filters"
tag[39.43621]="1"
...
tag[39.437111]="1"
spec[39.437121]="group:"
value[39.437121]=" is the group of the referent extensionRef of filters in httpRoute"
tag[39.437121]="1"
