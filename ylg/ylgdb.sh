...
tag[26.1019]="0"
spec[26.1020]="- name:"
value[26.1020]="Name of the Volume and the mount path enter value as name;path-of-mount here"
tag[26.1020]="1"
spec[26.10201]="mountPath:"
value[26.10201]="Path within the container at which the volume should be mounted. Must not contain colon"
tag[26.10201]="0"
spec[26.10202]="mountPropagation:"
value[26.10202]="determines how mounts are propagated from the host to container and the other way around"
tag[26.10202]="1"
spec[26.10203]="readOnly:"
value[26.10203]="Mount volume value read-only if true"
tag[26.10203]="0"
spec[26.10204]="subPath:"
value[26.10204]="Path within the volume from which the container's volume should be mounted.(Default to toor)"
tag[26.10204]="1"
spec[26.10205]="subPathExpr:"
value[26.10205]="Expanded path within the volume from which the container's volume should be mounted."
tag[26.10205]="1"
spec[26.1021]="volumeDevices:"
value[26.1021]="volumeDevices is the list of block devices to be used by the container."
tag[26.1021]="0"
spec[26.1022]="- name:"
value[26.1022]="name must match the name of a persistentVolumeClaim in the pod"
tag[26.1022]="1"
spec[26.10221]="devicePath:"
value[26.10221]="devicePath is the path inside of the container that the device will be mapped to"
tag[26.10221]="1"
spec[27.1021]="resources:"
value[27.1021]="Compute Resources required by this container"
tag[27.1021]="0"
spec[27.1022]="- claims:"
value[27.1022]="Claims lists the names of resources defined in spec.resourceClaims that are used by this container"
tag[27.1022]="0"
spec[27.10221]="name:"
value[27.10221]="Name must match the name of one entry in pod.spec.resourceClaims of the Pod where this field is used"
tag[27.10221]="1"
spec[27.1023]="limits:"
value[27.1023]="Limits describes the maximum amount of compute resources allowed"
tag[27.1023]="0"
spec[27.1024]="requests:"
value[27.1024]="Requests describes the minimum amount of compute resources required"
tag[27.1024]="0"
spec[27.1025]="resizePolicy:"
value[27.1025]="Resources resize policy for the container"
tag[27.1025]="0"
spec[27.1026]="- resourceName:"
value[27.1026]="Name of the resource to which this resource resize policy applies(cpu/memory)"
tag[27.1026]="1"
spec[27.10261]="restartPolicy:"
value[27.10261]="Restart policy to apply when specified resource is resized"
tag[27.10261]="1"
...
tag[27.1027]="0"
spec[27.1028]="- postStart:"
value[27.1028]="PostStart is called immediately after a container is created. If the handler fails the container is terminated and restarted according to its restart policy"
tag[27.1028]="0"
spec[27.10281]="preStop:"
value[27.10281]="PreStop is called immediately before a container is terminated due to an API request or management event such as liveness/startup probe failure"
tag[27.10281]="0"
...
tag[27.1034]="0"
spec[27.1035]="- runAsUser:"
value[27.1035]="The UID to run the entrypoint of the container process"
tag[27.1035]="1"
spec[27.10351]="runAsNonRoot:"
value[27.10351]="Indicates that the container must run as a non-root user(Boolean)"
tag[27.10351]="1"
spec[27.10352]="runAsGroup:"
value[27.10352]="GID to run the entrypoint of the container process(int)"
tag[27.10352]="1"
spec[27.10353]="readOnlyRootFilesystem:"
value[27.10353]="Whether this container has a read-only root filesystem(Boolean)"
tag[27.10353]="1"
...
tag[27.10357]="0"
spec[27.10358]="- add:"
value[27.10358]="Adds POSIX capabilities"
tag[27.10358]="1"
spec[27.103581]="drop:"
value[27.103581]="remove POSIX capabilities"
tag[27.103581]="1"
...
tag[27.10359]="0"
spec[27.10360]="- type:"
value[27.10360]="type indicates which kind of seccomp profile will be applied(localhost/RuntimeDefault/Unconfined)"
tag[27.10360]="1"
spec[27.103601]="localhostProfile:"
value[27.103601]="localhostProfile indicates a profile defined in a file on the node should be used"
tag[27.103601]="1"
spec[27.10361]="seLinuxOptions:"
value[27.10361]="SELinux context to be applied to the container"
tag[27.10361]="0"
spec[27.10362]="- level:"
value[27.10362]="Level is SELinux level label that applies to the container(string)"
tag[27.10362]="1"
spec[27.103621]="role:"
value[27.103621]="Role is a SELinux role label that applies to the container(string)"
tag[27.103621]="1"
spec[27.103622]="type:"
value[27.103622]="Type is a SELinux type label that applies to the container(string)"
tag[27.103622]="1"
spec[27.103623]="user:"
value[27.103623]="User is a SELinux user label that applies to the container(string)"
tag[27.103623]="1"
...
tag[27.10363]="1"
spec[27.10364]="- hostProcess:"
value[27.10364]="HostProcess determines if a container should be run as a 'Host Process' container(Boolean)"
tag[27.10364]="1"
spec[27.103641]="runAsUserName:"
value[27.103641]="UserName in Windows to run the entrypoint of the container process(string)"
tag[27.103641]="1"
spec[29.100]="volumes:"
...
tag[29.1015]="0"
spec[29.10151]="name:"
value[29.10151]="Enter the configmap name with accessmode as name value;defaultmode here"
tag[29.10151]="1"
