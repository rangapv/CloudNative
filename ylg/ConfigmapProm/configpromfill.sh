...
#This file gets called in the configpromgen.sh script for filling the skeletal configmap-promth.yaml file with the filled configmap-promth-value.yaml file that the user populates.
...
sortit
pvfill "configmap-promth-value.yaml" "configmap-promth.yaml"
