...
#USUAGE: ./configpromgen.sh gen (will generate the Skeletal YAML configmap-promth.yaml and configmap-promth-value.yaml a human readable file to fill values)
#USUAGE: ./configpromgen.sh (SAME as above ....will generate the Skeletal YAML configmap-promth.yaml and configmap-promth-value.yaml a human readable file to fill values)
#USUAGE: ./configpromgen.sh fill (The program takes the FILLED configmap-promth-value.yaml file generated ealier from above step and popluates the Skeletal configmap-promth.yaml with configmap-promth-value.yaml values)
